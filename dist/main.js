...
module.exports = "<h2>Affichage des cartes Trello sous la forme d'un Gantt</h2>\r\n\r\n<form class=\"example-form\">\r\n  <mat-form-field>\r\n    <mat-select placeholder=\"Choisir un tableau\" [(ngModel)]=\"boardSelected.id\" (ngModelChange)=\"updateGantt()\" name=\"board\">\r\n      <mat-option *ngFor=\"let board of boards | async\" [value]=\"board.id\">\r\n        {{board.name}}\r\n      </mat-option>\r\n    </mat-select>\r\n  </mat-form-field>\r\n  <mat-form-field *ngIf=\"boardSelected.members\">\r\n    <mat-select placeholder=\"Choisir un membre\" [(ngModel)]=\"memberFiltered\" (ngModelChange)=\"updateGantt()\" name=\"member\">\r\n      <mat-option value=\"\">Tous</mat-option>\r\n      <mat-option *ngFor=\"let member of boardSelected.members\" [value]=\"member.id\">\r\n        {{member.fullName}}\r\n      </mat-option>\r\n    </mat-select>\r\n  </mat-form-field>\r\n</form>\r\n\r\n<div #gantt_here style='width: 100%; height: 100%;'></div>\r\n\r\n"
...
/* harmony import */ var _service_task_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../service/task.service */ "./src/service/task.service.ts");
/* harmony import */ var _service_trello_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../service/trello.service */ "./src/service/trello.service.ts");
/* harmony import */ var _model_board__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../model/board */ "./src/model/board.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(taskService, trelloService) {
        this.taskService = taskService;
        this.trelloService = trelloService;
        this.boardSelected = new _model_board__WEBPACK_IMPORTED_MODULE_4__["Board"]();
    }
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.trelloService.authorize();
        this.boards = this.trelloService.getBoards();
        this.boards.subscribe(function (b) {
            if (b[0]) {
                _this.boardSelected = b[0];
            }
            _this.updateGantt();
        });
        ...
        gantt.templates.task_text = function (start, end, task) {
            var marker = task.marker ? "<i class=\"fas fa-skull-crossbones\"></i> " : "";
            return task.users ?
    ...
    AppComponent.prototype.updateGantt = function (member) {
        var _this = this;
        gantt.clearAll();
        if (this.boardSelected) {
            var cards = this.trelloService.getCards(this.boardSelected.id);
            cards.subscribe(function (c) {
                var filteredCards = c.filter(function (anyCard) {
                    return !_this.memberFiltered || anyCard.idMembers.includes(_this.memberFiltered);
                });
                _this.taskService.get(filteredCards)
                    .then(function (data) {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])("gantt_here"),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], AppComponent.prototype, "ganttContainer", void 0);
    AppComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'my-app',
            template: __webpack_require__(/*! ./app.component.html */ "./src/app/app.component.html"),
            providers: [_service_task_service__WEBPACK_IMPORTED_MODULE_2__["TaskService"], _service_trello_service__WEBPACK_IMPORTED_MODULE_3__["TrelloService"]]
        }),
        __metadata("design:paramtypes", [_service_task_service__WEBPACK_IMPORTED_MODULE_2__["TaskService"], _service_trello_service__WEBPACK_IMPORTED_MODULE_3__["TrelloService"]])
    ], AppComponent);
    return AppComponent;
}());
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatFormFieldModule"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatSelectModule"], _angular_material__WEBPACK_IMPORTED_MODULE_7__["MatOptionModule"]],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _model_task__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../model/task */ "./src/model/task.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TaskService = /** @class */ (function () {
     ...
     */
    TaskService.prototype.get = function (cards) {
        var myTasks = [];
        cards.forEach(function (card) {
            var startDate;
            var endDate = new Date(card.due);
            var users = false;
            // On récupére la date de début si elle existe
            var startDateItem = card.customFieldItems
            ...
            var t = new _model_task__WEBPACK_IMPORTED_MODULE_1__["Task"]();
            t.id = card.id;
            t.text = card.name;
...
var TrelloService = /** @class */ (function () {
    function TrelloService(http) {
        this.http = http;
        this.key = '08c1c082c7cb12602cdccdbc55428bad';
    }
    /**
     * Authentification avec Trello
     */
    TrelloService.prototype.authorize = function () {
        var _this = this;
        window['Trello'].authorize({
            ...
            expiration: 'never',
            success: function () {
                _this.token = window['Trello'].token();
            },
            error: function () {
                console.log("ça pue !");
            },
    ...
    TrelloService.prototype.getBoards = function () {
        var path = "https://api.trello.com/1//member/me/boards?members=all&key=" + this.key + "&token=" + this.token;
     ...
     * @returns {Observable<any>}
     */
    TrelloService.prototype.getCards = function (boardId) {
        var path = "https://api.trello.com/1/boards/" + boardId + "/cards?customFieldItems=true&key=" + this.key + "&token=" + this.token;
        return this.http.get(path);
    };
...
module.exports = __webpack_require__(/*! C:\Users\fwatt\PhpstormProjects\trello-gantt-app\src\main.ts */"./src/main.ts");
